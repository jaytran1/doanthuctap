...
class LoaiBDSController extends Controller
{
    ...
    public function postThem(Request $request){
        $this->validate($request,
            ...
            [
                'tenloai.required'=>'Tên loại không hợp lệ',
                'tenloai.min'=>'Ít nhất 3 kí tự',
                'tenloai.unique'=>'Loại bất động sản đã có'
            ]);
        $loaibds= new LoaiBDS();
        ...
        return redirect('admin/loaibds/them')->with('thongbao','Thêm loại bds thành công');
    }
